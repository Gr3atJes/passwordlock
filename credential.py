...
class Credential:
    ...
    email: New credential email address.(str)
    ...
    def find_by_platform(cls,platform):
        '''
        Method that takes in a platform and return a credential that matches that name
    ...
    def generate_password(cls,length):
        ...
        the length of the password is determined by the length passed in the functions parameter
        Args:
